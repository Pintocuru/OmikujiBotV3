...
<script setup lang="ts">
  ...
  import CommentEventEditor from '@/editor/events/eventsComment/CommentEditor.vue'
  import TimerEventEditor from '@/editor/events/eventsTimer/TimerEditor.vue'
  import MetaEventEditor from '@/editor/events/eventsService/ServiceEditor.vue'
  import ReactionEventEditor from '@/editor/events/eventsReaction/ReactionEditor.vue'
  import ActionSetsEditor from '@/editor/events/actionSets/ActionSetsEditor.vue'
  import PlaceholderEditor from '@/editor/events/placeholders/PlaceholderEditor.vue'
  import CharacterEditor from '@/editor/events/characters/CharacterEditor.vue'
  import UiEditor from '@/editor/UiEditor/UiEditor.vue'
  import AppInfoEditor from '@/editor/events/appInfo/AppInfoEditor.vue'
  import JsonMergeEditor from '@/editor/events/JsonMerge/JsonMergeEditor.vue'
  ...
  const editorMap: Record<CategoryType, any> = {
    ...
    services: MetaEventEditor,
    reactions: ReactionEventEditor,
    box: ActionSetsEditor,
    actions: ActionSetsEditor,
