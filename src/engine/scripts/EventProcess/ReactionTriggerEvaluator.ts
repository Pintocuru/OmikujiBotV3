...
import type { ReactionReaction } from "@/types/OmikujiData/ReactionTriggerSchema";

export function evaluateReactionTrigger(
  trigger: ReactionTriggerType,
  stats: ReactionStatsManagerType,
): boolean {
