<!-- src/MainGenerator/ui/StreamCounter/layouts/BasicCirclePlain.vue -->
<template>
  <div class="relative w-32 h-32 flex items-center justify-center transition duration-150 pixel-badge">
    ...
    <!-- 内側円 -->
    <div
      class="absolute rounded-full w-24 h-24 shadow-inner bg-base-content text-base-200 flex flex-col items-center justify-center"
    >
      <!-- アイコン -->
      ...
      <div class="flex items-baseline justify-center whitespace-nowrap">
        ...
        >
          <span :key="value" class="text-4xl font-bold `text-base-200` transition-all duration-300">
            {{ value }}
          </span>
        </TransitionGroup>
      </div>
