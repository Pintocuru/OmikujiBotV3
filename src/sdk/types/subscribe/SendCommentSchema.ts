 ...
 * 基本のスキーマ
 */
// TODO:あとでID生成のための「core」を用意したい
export const idSchema = z.string().default(nanoid()).catch(nanoid());
...
export const SendTestCommentSchema = z.object({
  platform: z.enum(serviceTypeValues).default("youtube"), // プラットフォーム（youtube）
