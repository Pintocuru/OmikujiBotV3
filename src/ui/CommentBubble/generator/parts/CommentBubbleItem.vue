<!-- src/ui/CommentBubble/generator/parts/CommentBubbleItem.vue -->
<template>
  <div
    class="relative transparent-bg inline-block max-w-3xl min-w-40"
  ...
  >
    ...
    <!-- コメント内容（HTML を描画） -->
    <div class="wrap-break-word text-xl" :class="uiMap.text.class" :style="uiMap.text.style" v-html="displayedHtml" />
